...
void DivEngine::registerSystems() {
  ...
  sysDefs[DIV_SYSTEM_YM2609]=new DivSysDef(
    ...
    DivChanDefFunc({
      ...
      DivChanDef(_("PSG 2")    , "S2", DIV_CH_PULSE, DIV_INS_AY),
      DivChanDef(_("PSG 3")    , "S3", DIV_CH_PULSE, DIV_INS_AY),
      DivChanDef(_("PSG 4")    , "S4", DIV_CH_PULSE, DIV_INS_AY),
      DivChanDef(_("PSG 5")    , "S5", DIV_CH_PULSE, DIV_INS_AY),
      DivChanDef(_("PSG 6")    , "S6", DIV_CH_PULSE, DIV_INS_AY),
      DivChanDef(_("PSG 7")    , "S7", DIV_CH_PULSE, DIV_INS_AY),
      DivChanDef(_("PSG 8")    , "S8", DIV_CH_PULSE, DIV_INS_AY),
      DivChanDef(_("PSG 9")    , "S9", DIV_CH_PULSE, DIV_INS_AY),
