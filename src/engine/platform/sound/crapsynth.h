...
#define STM32CRAPSYNTH_NUM_CHANNELS 14
#define STM32CRAPSYNTH_FLASH_SAMPLE_MEM_SIZE (512 * 1024 - 16 * 1024) /*512 KiB in total with 16 KiB for firmware*/
#define STM32CRAPSYNTH_RAM_SAMPLE_MEM_SIZE (1024 * 52) /* 52 KiB */
